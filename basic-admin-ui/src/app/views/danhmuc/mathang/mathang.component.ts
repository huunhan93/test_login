...
@Component({
  ...
  styleUrls: ['./mathang.component.scss'],
})
export class MatHangComponent implements OnInit, OnDestroy {
  ...
  loadData(selectionId = null) {
    ...
    this.postApiClient.getPostsPaging(this.keyword, this.loaiId, this.pageIndex, this.pageSize)
