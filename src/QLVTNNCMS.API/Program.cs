using QLVTNNCMS.Api.Authorization;
using QLVTNNCMS.API.Filters;
using QLVTNNCMS.Api.Services;
using QLVTNNCMS.Api;
using QLVTNNCMS.Core.ConfigOptions;
using QLVTNNCMS.Core.Domain.Identity;
using QLVTNNCMS.Core.Models.Content;
using QLVTNNCMS.Core.SeedWorks;
using QLVTNNCMS.Core.Services;
using QLVTNNCMS.Data.Repositories;
using QLVTNNCMS.Data.SeedWorks;
using QLVTNNCMS.Data.Services;
...
builder.Services.AddDbContext<QLVTNNCMSContext>(options =>
                options.UseSqlServer(connectionString));

builder.Services.AddIdentity<AppUser, AppRole>(options => options.SignIn.RequireConfirmedAccount = false)
    .AddEntityFrameworkStores<QLVTNNCMSContext>();
