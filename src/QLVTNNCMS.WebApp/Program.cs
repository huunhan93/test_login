...
using QLVTNNCMS.Core.Events.LoginSuccessed;
...
using QLVTNNCMS.WebApp.Helpers;
using QLVTNNCMS.WebApp.Services;
...
builder.Services.AddDbContext<QLVTNNCMSContext>(options => options.UseSqlServer(connectionString));
