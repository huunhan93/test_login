...
class BarChartSample extends StatefulWidget{
  ...
  BarChartSample({Key? key, required this.listCategories}) : super(key: key);
      ...
      child: AspectRatio(
        ...
        child: BarChart(
          BarChartData(
            ...
            barGroups: widget.listCategories.asMap().entries.map((e) {
              final index = e.key;
              final data = e.value;
              return generateBarGroup(
                index,
                new Color(data.iconColor),
                data.totalPost.toDouble(),
                data.totalPost.toDouble(),
              );
            }).toList(),
            maxY: 20,
